# PySpider (Modified for educational purposes) 

This version of the [pyspider](https://github.com/binux/pyspider) project has been modified for educational purposes. 
The original README with instructions and project description is provided below. 
---
